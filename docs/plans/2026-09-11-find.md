# Omascape — Find (type-ahead window search) Implementation Plan
...
**Branch:** `git checkout find`. Work in `~/Source/omascape`.
...
Run: `cd ~/Source/omascape && QT_QPA_PLATFORM=offscreen /usr/lib/qt6/bin/qmltestrunner -input tests/tst_find.qml`
